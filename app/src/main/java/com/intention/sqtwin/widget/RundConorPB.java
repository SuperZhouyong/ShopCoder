 ...
 */
public class RundConorPB extends LinearLayout {
    ...
    public RundConorPB(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (isInEditMode()) {
    ...
    public RundConorPB(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            layoutBackground.setBackground(backgroundDrawable);
            layoutBackground.setBackground(getResources().getDrawable(R.drawable.pb_bg_major));
        } else {
            layoutBackground.setBackgroundDrawable(getResources().getDrawable(R.drawable.pb_bg_major));
//            layoutBackground.setBackgroundDrawable(backgroundDrawable);
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<RundConorPB.SavedState>() {
            public RundConorPB.SavedState createFromParcel(Parcel in) {
                return new RundConorPB.SavedState(in);
            }

            public RundConorPB.SavedState[] newArray(int size) {
                return new RundConorPB.SavedState[size];
            }
        };
    }
