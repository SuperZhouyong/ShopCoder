package cn.hancang.www.widget.wheelpicker;
...
//            Log.i("mTextMaxWidth","mTextMaxWidth ========= "+0);
...
//            Log.i("mTextMaxWidth","mTextMaxWidth ========= "+1);
        } else if (!TextUtils.isEmpty(mMaxWidthText)) {
            mTextMaxWidth = (int) mPaint.measureText(mMaxWidthText);
//            Log.i("mTextMaxWidth","mTextMaxWidth ========= "+2);
        } else {
//            Log.i("mTextMaxWidth","mTextMaxWidth ========= "+3);
...
//        Log.i("mTextMaxWidth","mTextMaxWidth ========= "+mTextMaxWidth);
...
//            mPaint.setTextAlign(Paint.Align.LEFT);
            ...
            // 计算字体长度
            float measureText = mPaint.measureText(data);
//            float measurePoint = mPaint.measureText("...");
