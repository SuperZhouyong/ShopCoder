...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void createGuideView() {
        ...
        guideViewParams.width = (int) mContent.getResources().getDimension(R.dimen.x451);
        guideViewParams.height =(int)mContent.getResources().getDimension(R.dimen.y368) ;
...
//                        guideViewParams.setMargins(right + offsetX, bottom + offsetY, -right - offsetX, -top - offsetY);
                        guideViewParams.setMargins(0,center[1],radius/4,0);
