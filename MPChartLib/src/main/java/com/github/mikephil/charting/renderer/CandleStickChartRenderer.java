            ...
            if (showCandleBar) {
                ...
                if (open > close) { // decreasing
                    ...
                    /*c.drawRect(
                            ...
                            mRenderPaint);*/
                    c.drawRect( mBodyBuffers[0], mBodyBuffers[3]>mBodyBuffers[1]?mBodyBuffers[1]:mBodyBuffers[3],
                            mBodyBuffers[2], mBodyBuffers[3]>mBodyBuffers[1]?mBodyBuffers[3]:mBodyBuffers[1],
                            mRenderPaint);
