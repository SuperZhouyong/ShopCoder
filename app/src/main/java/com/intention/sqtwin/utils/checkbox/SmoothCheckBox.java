...
package com.intention.sqtwin.utils.checkbox;
...
//        mStrokeWidth = (mStrokeWidth > 2) ? 2 : mStrokeWidth;
        mStrokeWidth = CompatUtils.dp2px(getContext(), 2.5f);
        LogUtils.logd("mStrokeWidth" + mStrokeWidth);
