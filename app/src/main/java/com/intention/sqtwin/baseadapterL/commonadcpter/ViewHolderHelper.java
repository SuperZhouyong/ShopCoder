...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setTextBoldandColor(int viewId, String text) {
        TextView tv = getView(viewId);
        tv.getPaint().setFakeBoldText(true);
        tv.setTextColor(mContext.getResources().getColor(R.color.app_main));
        tv.setText(text);
        return this;
    }
    public ViewHolderHelper setTextColorFont1(int viewId, String text) {
        ...
        tv.setTextColor(mContext.getResources().getColor(R.color.font_1));
        tv.setText(text);
        return this;
    }
    ...
    public ViewHolderHelper setImageFixCenter(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.dispFixlay(mContext, view, url);
        return this;
    }
