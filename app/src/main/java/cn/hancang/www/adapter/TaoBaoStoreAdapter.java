...
/**
 * Description: 保佑无bug
 * Data：2018/6/30-上午10:24
 * Blog：Super简单
 * Author: ZhouYong
 * QQ: 437397161
 */

public class TaoBaoStoreAdapter extends CommonRecycleViewAdapter<TaobaoStoreInfoBean.DataBean.AuctionFieldListBean> {
    ...
    public TaoBaoStoreAdapter(Context context) {
...
//                RxBus.getInstance().post(AppConstant.MallFiled, new FavBean(position, recommendFieldBean.getId()));
        ...
        helper.getConvertView().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AuctionFiledActivity.gotoAuctionFiledActivity((BaseActivity) mContext, recommendFieldBean.getId(), AppConstant.IntoWayOne);
            }
        });
