...
public class LRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        // 每次在这里加1  最后一个就代表了  加载更多的footView
        if (mInnerAdapter != null) {
            Log.i(TAG,"getItemCount----"+(getHeaderViewsCount() + getFooterViewsCount() + mInnerAdapter.getItemCount() + 1)+"----"+ getHeaderViewsCount()+"----"+getFooterViewsCount()+"---"+mInnerAdapter.getItemCount());
